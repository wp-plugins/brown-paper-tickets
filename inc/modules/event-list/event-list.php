...
class EventList extends \BrownPaperTickets\Modules\Module {
	...
	public function load_admin_ajax_actions() {
		add_action( 'wp_ajax_bpt_set_price_max_quantity', array( 'BrownPaperTickets\Modules\EventList\Ajax', 'set_price_max_quantity' ) );
		add_action( 'wp_ajax_bpt_hide_prices', array( 'BrownPaperTickets\Modules\EventList\Ajax', 'hide_prices' ) );
		add_action( 'wp_ajax_bpt_unhide_prices', array( 'BrownPaperTickets\Modules\EventList\Ajax', 'unhide_prices' ) );
		add_action( 'wp_ajax_bpt_get_events', array( 'BrownPaperTickets\Modules\EventList\Ajax', 'get_events' ) );
	}
